...
namespace MineSweeper
{
    public class UIBlock : Label
    {
        ...
        public void FetchState()
        {
            ...
            if (TheMgr.Mode.HasFlag(SolvingMode.Reduce) &&
                !TheMgr.Succeed &&
                TheMgr.InferredStatuses != null)
            {
                switch (TheMgr.InferredStatuses[TheBlock.Index])
                {
                    ...
                    default:
                        ...
                        else if (TheMgr.Mode.HasFlag(SolvingMode.Drained) &&
                                 TheMgr.DrainProbabilities != null)
                        {
                            var v = (int)(TheMgr.DrainProbabilities[TheBlock.Index] * 255);
