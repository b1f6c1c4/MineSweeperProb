...
void enumerator_logic::finalize(const area_it &ait)
{
	if (ait->empty())
		return;
...
enumerator_logic::enumerator_logic(grid_t<blk_t> &grid, std::shared_ptr<logic_config> config)
...
logic_result enumerator_logic::try_full_logic(const bool force)
{
...
void enumerator_logic::speculative_fork(fork_directive &&directive)
{
